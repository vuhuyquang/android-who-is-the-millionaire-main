...
public class MoneyRewardAdapter extends ArrayAdapter<String> {
    Context mct;
    ArrayList<String> arr;
    int viTriCauHoi =1;

    public MoneyRewardAdapter(Context context, int resource, List<String> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if(convertView == null){
            ...
            convertView = inflater.inflate(R.layout.item_money_reward,null);
        }
        if(arr.size()>0){
            int pos = 15 - position;
